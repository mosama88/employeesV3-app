...
@section('css')
		...
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/ratings.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bars-1to10.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bars-movie.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bars-square.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bars-pill.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bars-reversed.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bars-horizontal.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/fontawesome-stars.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/css-stars.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/bootstrap-stars.css')}}">
		<link rel="stylesheet" href="{{URL::asset('dashboard/assets/plugins/rating/themes/fontawesome-stars-o.css')}}">
@endsection
@section('page-header')
				<!-- breadcrumb -->
