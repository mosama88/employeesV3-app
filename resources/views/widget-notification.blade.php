				...
				<div class="row row-sm">
					<div class="col-lg-4 col-md-4">
						<div class="card mg-b-20 text-center">
							<div class="card-body">
								<img src="{{URL::asset('dashboard/assets/img/svgicons/no-data.svg')}}" alt="" class="wd-35p">
					...
					<div class="col-lg-4 col-md-4">
						<div class="card mg-b-20 text-center">
							<div class="card-body">
								<img src="{{URL::asset('dashboard/assets/img/svgicons/note_taking.svg')}}" alt="" class="wd-35p">
					...
					<div class="col-lg-4 col-md-4">
						<div class="card mg-b-20 text-center">
							<div class="card-body">
								<img src="{{URL::asset('dashboard/assets/img/svgicons/imac.svg')}}" alt="" class="wd-40p">
