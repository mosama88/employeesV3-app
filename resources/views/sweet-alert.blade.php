...
<script src="{{URL::asset('dashboard/assets/plugins/sweet-alert/sweetalert.min.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/plugins/sweet-alert/jquery.sweet-alert.js')}}"></script>
<!-- Sweet-alert js  -->
<script src="{{URL::asset('dashboard/assets/plugins/sweet-alert/sweetalert.min.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/js/sweet-alert.js')}}"></script>
@endsection
