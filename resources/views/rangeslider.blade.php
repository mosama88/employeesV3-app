...
<link href="{{URL::asset('dashboard/assets/plugins/ion-rangeslider/css/ion.rangeSlider.css')}}" rel="stylesheet">
<link href="{{URL::asset('dashboard/assets/plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('dashboard/assets/js/rangeslider.js')}}"></script>
@endsection
