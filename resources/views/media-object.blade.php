								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}">
						...
						<div class="card" id="media-object2">
							<div class="card-body">
								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}">
											<div class="media-body">
												<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
												...
												<div class="media d-block d-sm-flex mg-t-25">
													<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('dashboard/assets/img/faces/8.jpg')}}">
													<div class="media-body">
														<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
														Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
													</div>
						...
						<div class="card" id="media-object3">
							<div class="card-body">
								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0 align-self-center" src="{{URL::asset('dashboard/assets/img/faces/14.jpg')}}">
											<div class="media-body">
												<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
								...
								<div class="text-wrap">
									<div class="example">
										<div class="media d-block d-sm-flex">
											...
											<img alt="" class="main-img-user avatar-lg mg-sm-r-20 mg-t-20 mg-sm-t-0" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}">
										</div>
									</div>
										...
										<div class="media media-list d-block d-sm-flex">
											<ul class="list-unstyled mb-0">
												<li class="media d-block d-sm-flex">
													<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}">
													<div class="media-body">
														<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
														Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
													</div>
												...
												<li class="media d-block d-sm-flex mg-t-25">
													<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}">
													<div class="media-body">
														<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
														Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
													</div>
												...
												<li class="media d-block d-sm-flex mg-t-25">
													<img alt="" class="main-img-user avatar-lg mg-sm-l-20 mg-b-20 mg-sm-b-0" src="{{URL::asset('dashboard/assets/img/faces/7.jpg')}}">
													<div class="media-body">
														<h5 class="mg-b-5 tx-inverse tx-15">Media heading</h5>
														Lorem Ipsum generators on the Internet as necessary aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit
													</div>
