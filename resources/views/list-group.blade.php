								...
								<div class="text-wrap">
									<div class="example">
										<div class="list-group">
											<a class="list-group-item list-group-item-action flex-column align-items-start active" href="#">
												<span class="d-flex">
													<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}">
													<div class="">
														<div class="d-flex w-100 justify-content-between">
															<h5 class="mb-2 tx-14">List group item heading</h5><small>3 days ago</small>
														</div>
											...
											<a class="list-group-item list-group-item-action flex-column align-items-start" href="#">
												<span class="d-flex">
													<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/8.jpg')}}">
													<div class="">
														<div class="d-flex w-100 justify-content-between">
															<h5 class="mb-2 tx-14">List group item heading</h5><small>3 days ago</small>
														</div>
											...
											<a class="list-group-item list-group-item-action flex-column align-items-start" href="#">
												<span class="d-flex">
													<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/11.jpg')}}">
													<div class="">
														<div class="d-flex w-100 justify-content-between">
															<h5 class="mb-2 tx-14">List group item heading</h5><small>3 days ago</small>
														</div>
									...
									<div class="example">
										<div class="list-group">
											<div class="list-group-item pd-y-20">
												<div class="media">
													<div class="d-flex mg-l-10 wd-50">
														<img class="ml-4 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/17.jpg')}}" alt="avatar">
													</div>
											...
											<div class="list-group-item pd-y-20">
												<div class="media">
													<div class="d-flex mg-l-10 wd-50">
														<img class="ml-4 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}" alt="avatar">
													</div>
													<div class="media-body">
														<div class="media-body d-flex">
											...
											<div class="list-group-item pd-y-20">
												<div class="media">
													<div class="d-flex mg-l-10 wd-50">
														<img class="ml-4 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}" alt="avatar">
													</div>
													<div class="media-body">
														<div class="media-body d-flex">
									...
									<div class="example">
										<ul class="list-group wd-md-100p users-list-group">
											<li class="list-group-item d-flex align-items-center">
												<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}">
												<div>
											...
											<li class="list-group-item d-flex align-items-center">
												<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}">
												<div>
											...
											<li class="list-group-item d-flex align-items-center">
												<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/15.jpg')}}">
												<div>
													<h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span class="d-block tx-13 text-muted">Premium Member</span>
												</div>
												<div class="d-flex float-right mr-auto">
											...
											<li class="list-group-item d-flex align-items-center">
												<img alt="" class="ml-3 rounded-circle avatar-md" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}">
												<div>
