							...
							<div class="main-content-left main-content-left-chat">
								...
								<div class="main-chat-contacts-wrapper">
									...
									<div class="main-chat-contacts" id="chatActiveContacts">
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}"></div><small>Adrian</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}"></div><small>John</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}"></div><small>Daniel</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/13.jpg')}}"></div><small>Katherine</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}"></div><small>Raymart</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/14.jpg')}}"></div><small>Junrisk</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}"></div><small>George</small>
										</div>
										<div>
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/15.jpg')}}"></div><small>Maryjane</small>
										</div>
										<div>
								...
								<div class="main-chat-list" id="ChatList">
									<div class="media new">
										<div class="main-img-user online">
											<img alt="" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}"> <span>2</span>
										</div>
									...
									<div class="media new">
										<div class="main-img-user">
											<img alt="" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}"> <span>1</span>
										</div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media selected">
										<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/11.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media new">
										<div class="main-img-user">
											<img alt="" src="{{URL::asset('dashboard/assets/img/faces/7.jpg')}}"> <span>1</span>
										</div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/8.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/15.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/10.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/7.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
									...
									<div class="media border-bottom-0">
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}"></div>
										<div class="media-body">
											<div class="media-contact-name">
						...
						<div class="card">
							...
							<div class="main-content-body main-content-body-chat">
								<div class="main-chat-header">
									<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}"></div>
									...
									<div class="content-inner">
										...
										<div class="media flex-row-reverse">
											...
											<div class="media-body">
												...
												<div class="main-msg-wrapper pd-0"><img alt="" class="wd-100 ht-100" src="{{URL::asset('dashboard/assets/img/ecommerce/01.jpg')}}"></div>
												<div>
										...
										<div class="media">
											<div class="main-img-user online"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}"></div>
											<div class="media-body">
...
<script src="{{URL::asset('dashboard/assets/plugins/lightslider/js/lightslider.min.js')}}"></script>
<!--Internal  Chat js -->
<script src="{{URL::asset('dashboard/assets/js/chat.js')}}"></script>
@endsection
