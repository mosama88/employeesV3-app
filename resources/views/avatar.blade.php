									...
									<div class="example">
										<div class="demo-avatar-group">
											<div class="main-img-user avatar-xs">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}">
											</div>
											<div class="main-img-user avatar-sm">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}">
											</div>
											<div class="main-img-user">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}">
											</div>
											<div class="main-img-user avatar-md">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}">
											</div>
											<div class="main-img-user avatar-lg">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}">
											</div>
											<div class="main-img-user avatar-xl d-none d-sm-block">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/7.jpg')}}">
											</div>
											<div class="main-img-user avatar-xxl d-none d-sm-block">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('dashboard/assets/img/faces/8.jpg')}}">
											</div>
										</div>
									</div>
								...
								<div class="text-wrap">
									<div class="example">
										<div class="demo-avatar-group">
											...
											<div class="main-img-user avatar-md">
												<img alt="avatar" class="square" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}">
											</div>
											<div class="main-img-user avatar-md">
												<img alt="avatar" class="radius" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}">
											</div>
										</div>
									</div>
										...
										<div class="example">
											<div class="demo-avatar-group">
												<div class="main-avatar avatar online">
													<img alt="avatar" class="rounded-circle avatar" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}">
												</div>
