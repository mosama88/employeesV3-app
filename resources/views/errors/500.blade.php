   ...
   <!-- Page -->
		<div class="page">
			...
			<div class="main-error-wrapper  page page-h ">
				<img src="{{ asset('dashboard') }}/assets/img/media/500.png" class="error-page" alt="error">
                <h2>حدث خطأ . الصفحة التي كنت تبحث عنها غير موجودة.</h2>
