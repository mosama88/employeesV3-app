                    ...
                    <div class="action-header clearfix">
                        <div class="float-left hidden-xs d-flex ml-2">
                            <div class="img_cont mr-3">
                                <img src="{{asset('dashboard')}}/assets/img/faces/6.jpg" class="rounded-circle user_img" alt="img">
                            </div>
                    ...
                    <div class="card-body msg_card_body">
                        ...
                        <div class="d-flex justify-content-start">
                            <div class="img_cont_msg">
                                <img src="{{asset('dashboard')}}/assets/img/faces/6.jpg" class="rounded-circle user_img_msg" alt="img">
                            </div>
                        ...
                        <div class="d-flex justify-content-end ">
                            ...
                            <div class="img_cont_msg">
                                <img src="{{asset('dashboard')}}/assets/img/faces/9.jpg" class="rounded-circle user_img_msg" alt="img">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start ">
                            <div class="img_cont_msg">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content bg-dark border-0 text-white">
                <div class="modal-body mx-auto text-center p-7">
                    ...
                    <img src="{{asset('dashboard')}}/assets/img/faces/6.jpg" class="rounded-circle user-img-circle h-8 w-8 mt-4 mb-3" alt="img">
