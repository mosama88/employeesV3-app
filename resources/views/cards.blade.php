...
@section('css')
<link href="{{URL::asset('dashboard/assets/plugins/morris.js/morris.css')}}" rel="stylesheet">
...
@section('content')
				...
				<div class="row row-sm">
					<div class="col-md-4 col-lg-4">
						<div class="card">
							<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/14.jpg')}}">
							<div class="card-body ">
					...
					<div class="col-md-4 col-lg-4 mg-md-t-0">
						<div class="card">
							<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/12.jpg')}}">
							<div class="card-body ">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
						</div>
					...
					<div class="col-md-4 col-lg-4 mg-md-t-0">
						<div class="card">
							<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/13.jpg')}}">
							<div class="card-body ">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
						</div>
				...
				<div class="row row-sm">
					<div class="col-md-4 col-lg-4">
						...
						<div class="card-body ">
							<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						</div><img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}"></div>
					</div><!-- col-4 -->
					<div class="col-md-4 col-lg-4 mg-md-t-0">
						<div class="card">
						<div class="card-body ">
							<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						</div><img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/2.jpg')}}"></div>
					</div><!-- col-4 -->
					<div class="col-md-4 col-lg-4 mg-md-t-0">
						<div class="card">
						<div class="card-body ">
							<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
						</div><img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/11.jpg')}}"></div>
					</div><!-- col-4 -->
				</div>
				<!-- /row closed -->
				...
				<div class="row row-sm">
					<div class="col-md">
						<div class="card">
							<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/3.jpg')}}">
					...
					<div class="col-md mg mg-md-t-0">
						<div class="card">
							<img alt="Image" class="card-img img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/5.jpg')}}">
							<div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
					...
					<div class="col-md mg-md-t-0">
						<div class="card">
							<img alt="Image" class="card-img img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/6.jpg')}}">
							<div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
				...
				<div class="row row-sm">
					<div class="col-lg-4 col-md-12 col-12 col-sm-12">
						<div class="card">
							<img class="card-img-top" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}" alt="Card image cap">
							<div class="card-body">
					...
					<div class="col-lg-4 col-md-12 col-12 col-sm-12">
						<div class="card">
							<img class="card-img-top" src="{{URL::asset('dashboard/assets/img/photos/2.jpg')}}" alt="Card image cap">
							<div class="card-body">
								<p class="card-text"> To take a trivial example, which of us ever undertakes laborious physical exercise.</p>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-12 col-12 col-sm-12">
						<div class="card">
							<img class="card-img-top" src="{{URL::asset('dashboard/assets/img/photos/3.jpg')}}" alt="Card image cap">
							<div class="card-body">
								<p class="card-text"> To take a trivial example, which of us ever undertakes laborious physical exercise.</p>
							</div>
						</div>
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card">
							<img class="card-img-top w-100" src="{{URL::asset('dashboard/assets/img/photos/4.jpg')}}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card">
							<img class="card-img-top w-100" src="{{URL::asset('dashboard/assets/img/photos/5.jpg')}}" alt="">
							<div class="card-body">
								<h4 class="card-title mb-3">Card Title</h4>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<a class="btn btn-primary" href="#">Read More</a>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card">
							<img class="card-img-top w-100" src="{{URL::asset('dashboard/assets/img/photos/6.jpg')}}" alt="">
							<div class="card-body">
								<h4 class="card-title mb-3">Card Title</h4>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<a class="btn btn-primary" href="#">Read More</a>
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card text-center">
							<img class="card-img-top w-100" src="{{URL::asset('dashboard/assets/img/photos/7.jpg')}}" alt="">
							<div class="card-body">
								<h4 class="card-title mb-3">Card Title</h4>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<a class="btn btn-primary" href="#">Read More</a>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card text-center">
							<img class="card-img-top w-100" src="{{URL::asset('dashboard/assets/img/photos/8.jpg')}}" alt="">
							<div class="card-body">
								<h4 class="card-title mb-3">Card Title</h4>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<a class="btn btn-primary" href="#">Read More</a>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<div class="card text-center">
							<img class="card-img-top w-100" src="{{URL::asset('dashboard/assets/img/photos/9.jpg')}}" alt="">
							<div class="card-body">
								<h4 class="card-title mb-3">Card Title</h4>
								<p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.</p>
								<a class="btn btn-primary" href="#">Read More</a>
