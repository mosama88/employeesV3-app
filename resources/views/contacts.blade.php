									...
									<div class="main-content-left main-content-left-contacts">
										...
										<div class="main-contacts-list" id="mainContactList">
											...
											<div class="main-contact-item selected">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}"></div>
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/7.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/8.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/10.jpg')}}"></div>
												<div class="main-contact-body">
											...
											<div class="main-contact-item">
												<div class="main-img-user online"><img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/11.jpg')}}"></div>
												<div class="main-contact-body">
								...
								<div class="main-contact-info-header pt-3">
									<div class="media">
										<div class="main-img-user">
											<img alt="avatar" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}"> <a href=""><i class="fe fe-camera"></i></a>
										</div>
...
@section('js')
<!--Internal  Contact js -->
<script src="{{URL::asset('dashboard/assets/js/contact.js')}}"></script>
@endsection
