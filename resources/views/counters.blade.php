					...
					<div class="col-sm-12 col-md-12 col-xl-4">
						<div class="card custom-card">
							<div class="card-body text-center">
								...
								<img src="{{URL::asset('dashboard/assets/img/media/illustrate.png')}}" alt="counter-image" class="wd-160 ht-160 ">
								<div class="pb-0 mt-3">
					...
					<div class="col-sm-12 col-md-12 col-xl-4">
						<div class="card custom-card">
							<div class="card-body text-center">
								...
								<img src="{{URL::asset('dashboard/assets/img/media/illustrate1.png')}}" alt="counter-image" class="wd-160 ht-160 ">
								<div class="mt-3">
					...
					<div class="col-sm-12 col-md-12 col-xl-4">
						<div class="card custom-card">
							<div class="card-body text-center ">
								...
								<img src="{{URL::asset('dashboard/assets/img/media/illustrate2.png')}}" alt="counter-image" class="wd-160 ht-160 ">
								<div class="mt-3">
...
<!--Internal Counters -->
<script src="{{URL::asset('dashboard/assets/plugins/counters/waypoints.min.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/plugins/counters/counterup.min.js')}}"></script>
<!--Internal Time Counter -->
<script src="{{URL::asset('dashboard/assets/plugins/counters/jquery.missofis-countdown.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/plugins/counters/counter.js')}}"></script>
@endsection
