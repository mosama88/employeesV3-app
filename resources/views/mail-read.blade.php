							...
							<div class="card-body">
								<div class="email-media">
									<div class="mt-0 d-sm-flex">
										<img class="ml-2 rounded-circle avatar-xl" src="{{URL::asset('dashboard/assets/img/faces/6.jpg')}}" alt="avatar">
								...
								<div class="eamil-body mt-5">
									...
									<div class="email-attch">
										...
										<div class="emai-img">
											<div class="d-sm-flex">
												<div class=" m-2">
													<a href="#"><img class="wd-150 mb-2" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}" alt="placeholder image"></a>
													<h6 class="mb-3 mb-lg-0">1.jpg <small class="text-muted">12kb</small></h6>
												</div>
												<div class="m-2">
													<a href="#"><img class="wd-150 mb-2" src="{{URL::asset('dashboard/assets/img/photos/2.jpg')}}" alt="placeholder image"></a>
													<h6 class="mb-3 mb-lg-0">2.jpg <small class="text-muted">18kb</small></h6>
												</div>
												<div class="m-2">
													<a href="#"><img class="wd-150 mb-2" src="{{URL::asset('dashboard/assets/img/photos/3.jpg')}}" alt="placeholder image"></a>
