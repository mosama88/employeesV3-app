...
<link href="{{URL::asset('dashboard/assets/plugins/darggable/jquery-ui-darggable.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
					...
					<div class="row row-sm">
						<div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
							...
							<div class="card custom-card card-draggable">
								<img alt="Image" class="img-fluid card-img-top" src="{{URL::asset('dashboard/assets/img/photos/1.jpg')}}">
								<div class="card-body">
...
<script src="{{URL::asset('dashboard/assets/plugins/darggable/jquery-ui-darggable.min.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/plugins/darggable/darggable.js')}}"></script>
@endsection
