									...
									<div class="example">
										<div class="row">
											<div class="col-6 col-md-3">
												<img alt="Responsive image" class="img-thumbnail" src="{{URL::asset('dashboard/assets/img/photos/9.jpg')}}">
											</div>
											<div class="col-6 col-md-3">
												<img alt="Responsive image" class="img-thumbnail" src="{{URL::asset('dashboard/assets/img/photos/13.jpg')}}">
											</div>
											<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
												<img alt="Responsive image" class="img-thumbnail" src="{{URL::asset('dashboard/assets/img/photos/14.jpg')}}">
											</div>
											<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
												<img alt="Responsive image" class="img-thumbnail" src="{{URL::asset('dashboard/assets/img/photos/15.jpg')}}">
											</div>
										</div>
									</div>
						...
						<div class="card custom-card" id="aligning">
							<div class="card-body ht-100p">
								...
								<div class="text-wrap">
									<div class="example">
										<div class="clearfix">
										  <img src="{{URL::asset('dashboard/assets/img/photos/10.jpg')}}" class="float-sm-left wd-100p wd-sm-200" alt="img">
										  <img src="{{URL::asset('dashboard/assets/img/photos/11.jpg')}}" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" alt="img">
										</div>
									</div>
										...
										<div class="row">
											<div class="col-xl-4 col-lg-4">
												<div class="img-thumbnail mb-3">
													<a href="#">
														<img src="{{URL::asset('dashboard/assets/img/photos/4.jpg')}}" alt="thumb1" class="thumbimg wd-100p">
													</a>
													<div class="caption">
											...
											<div class="col-xl-4 col-lg-4">
												<div class="img-thumbnail mb-3">
													<a href="#">
														<img src="{{URL::asset('dashboard/assets/img/photos/9.jpg')}}" alt="thumb1" class="thumbimg  wd-100p">
													</a>
													<div class="caption">
														<h5>Thumbnail label</h5>
														<p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
											...
											<div class="col-xl-4 col-lg-4">
												<div class="img-thumbnail mb-3">
													<a href="#">
														<img src="{{URL::asset('dashboard/assets/img/photos/8.jpg')}}" alt="thumb1" class="thumbimg  wd-100p">
													</a>
													<div class="caption">
														<h5>Thumbnail label</h5>
														<p>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
					...
					<div class="col-lg-6 col-md-12">
						<div class="card custom-card" id="responsive">
							<div class="card-body ht-100p">
								...
								<div class="text-wrap">
									<div class="example">
										<div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('dashboard/assets/img/photos/7.jpg')}}"></div>
									</div>
...
<!-- Prism Precode -->
<figure class="highlight clip-widget" id="images1"><pre><code class="language-markup"><script type="html-dashlead/script"><div><img alt="Responsive image" class="img-fluid" src="{{URL::asset('dashboard/assets/img/media/7.jpg')}}"></div>
</script></code></pre>
									...
									<div class="text-wrap">
										<div class="example">
											<figure class="pos-relative mg-b-0">
												<img alt="Responsive image" class="img-fit-cover" src="{{URL::asset('dashboard/assets/img/photos/12.jpg')}}">
...
<script src="{{URL::asset('dashboard/assets/plugins/custom-scroll/jquery.mCustomScrollbar.concat.min.js')}}"></script>
