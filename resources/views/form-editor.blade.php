...
<!--Internal  Quill css -->
<link href="{{URL::asset('dashboard/assets/plugins/quill/quill.snow.css')}}" rel="stylesheet">
<link href="{{URL::asset('dashboard/assets/plugins/quill/quill.bubble.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<!--Internal quill js -->
<script src="{{URL::asset('dashboard/assets/plugins/quill/quill.min.js')}}"></script>
<!-- Internal Form-editor js -->
<script src="{{URL::asset('dashboard/assets/js/form-editor.js')}}"></script>
@endsection
