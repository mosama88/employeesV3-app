...
<link href="{{URL::asset('dashboard/assets/plugins/accordion/accordion.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
				<!-- breadcrumb -->
											...
											<div class="border p-3">
												<div class="row">
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded" src="{{URL::asset('dashboard/assets/img/photos/8.jpg')}}" alt="banner image">
													</div>
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded" src="{{URL::asset('dashboard/assets/img/photos/10.jpg')}}" alt="banner image ">
													</div>
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded" src="{{URL::asset('dashboard/assets/img/photos/11.jpg')}}" alt="banner image ">
													</div>
													<div class="col-lg-3 col-md-6">
														<img class="img-fluid rounded " src="{{URL::asset('dashboard/assets/img/photos/12.jpg')}}" alt="banner image ">
													</div>
												</div>
											</div>
										</div>
...
<script src="{{URL::asset('dashboard/assets/plugins/accordion/accordion.min.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/js/accordion.js')}}"></script>
@endsection
