...
src="{{URL::asset('dashboard/assets/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
</figure>
										</div>
...
src="{{URL::asset('dashboard/assets/js/tabs.js')}}"</script></code></pre>
<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
</figure>
										</div>
									</div>
