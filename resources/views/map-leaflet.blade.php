...
<link href="{{URL::asset('dashboard/assets/plugins/leaflet/leaflet.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('dashboard/assets/plugins/leaflet/leaflet.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/js/map-leafleft.js')}}"></script>
@endsection
