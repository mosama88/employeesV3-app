							...
							<div class="main-content-body main-content-body-mail card-body">
								...
								<div class="main-mail-list">
									<div class="main-mail-item unread">
										...
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}"></div>
									...
									<div class="main-mail-item unread">
										...
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Albert Ansing
											</div>
									...
									<div class="main-mail-item">
										...
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/14.jpg')}}"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Marianne Audrey
											</div>
									...
									<div class="main-mail-item border-bottom-0">
										...
										<div class="main-img-user"><img alt="" src="{{URL::asset('dashboard/assets/img/faces/1.jpg')}}"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Jove Guden
											</div>
...
<script src="{{URL::asset('dashboard/assets/js/check-all-mail.js')}}"></script>
