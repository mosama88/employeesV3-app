				...
				<div class="row">
					...
					<div class="col-sm-12 col-xl-4 col-lg-12">
						<div class="card user-wideget user-wideget-widget widget-user">
							...
							<div class="widget-user-image">
								<img src="{{URL::asset('dashboard/assets/img/faces/17.jpg')}}" class="brround" alt="User Avatar">
							</div>
					...
					<div class="col-sm-12 col-xl-4 col-lg-12">
						<div class="card user-wideget user-wideget-widget widget-user">
							...
							<div class="widget-user-image">
								<img src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}" class="brround" alt="User Avatar">
							</div>
							<div class="user-wideget-footer">
								<div class="row">
									<div class="col-sm-4 border-left">
					...
					<div class="col-sm-12 col-xl-4 col-lg-12">
						<div class="card user-wideget user-wideget-widget widget-user">
							...
							<div class="widget-user-image">
								<img src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}" class="brround" alt="User Avatar">
							</div>
							<div class="user-wideget-footer">
								<div class="row">
									<div class="col-sm-4 border-left">
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="list d-flex align-items-center border-bottom py-3">
									<div class="avatar brround d-block cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}">
								...
								<div class="list d-flex align-items-center border-bottom py-3">
									<div class="avatar brround d-block cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/1.jpg')}}">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 mr-3">
										<p class="mb-0">
								...
								<div class="list d-flex align-items-center border-bottom py-3">
									<div class="avatar brround d-block cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/14.jpg')}}">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 mr-3">
										<p class="mb-0">
								...
								<div class="list d-flex align-items-center pt-3">
									<div class="avatar brround d-block cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}">
										<span class="avatar-status bg-green"></span>
									</div>
									<div class="wrapper w-100 mr-3">
										<p class="mb-0">
									...
									<div class="chips">
										<div class="team">
											<a href="javascript:void(0)" class="chip">
												<span class="avatar cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}"></span> Victoria
											</a>
										...
										<div class="team">
											<a href="javascript:void(0)" class="chip">
												<span class="avatar cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}"></span> Nathan
											</a>
											<i class="fab fa-facebook text-primary" aria-hidden="true"></i>
											<i class="fab fa-twitter text-primary" aria-hidden="true"></i>
											<i class="fas fa-envelope text-primary" aria-hidden="true"></i>
										...
										<div class="team">
											<a href="javascript:void(0)" class="chip">
												<span class="avatar cover-image" data-image-src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}"></span> Alice
											</a>
											<i class="fab fa-facebook text-primary" aria-hidden="true"></i>
											<i class="fab fa-twitter text-primary" aria-hidden="true"></i>
											<i class="fas fa-envelope text-primary" aria-hidden="true"></i>
						...
						<div class="card">
							...
							<div class="card-body p-0">
								<table class="table card-table country-table mb-0">
									<tbody>
										<tr>
											<td class="w-1"><img src="{{URL::asset('dashboard/assets/img/flags/us_flag.jpg')}}" alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>USA
										...
										<tr>
											<td class="w-1"><img src="{{URL::asset('dashboard/assets/img/flags/spain_flag.jpg')}}" alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Spain
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{URL::asset('dashboard/assets/img/flags/germany_flag.jpg')}}" alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Germany
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{URL::asset('dashboard/assets/img/flags/russia_flag.jpg')}}" alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Russia
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{URL::asset('dashboard/assets/img/flags/italy_flag.jpg')}}" alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>Italy
												<div class="progress progress-sm mt-1">
										...
										<tr>
											<td class="w-1"><img src="{{URL::asset('dashboard/assets/img/flags/french_flag.jpg')}}" alt="flags" class="flag wd-30 ht-20 flag-us mt-1"></i></td>
											<td>French
												<div class="progress progress-sm mt-1">
													<div class="progress-bar bg-teal wd-40"></div>
												</div>
						...
						<div class="card">
							...
							<div class="card-body pd-y-7">
								...
								<div class="wrapper d-flex justify-content-center image-group pb-3">
									<img src="{{URL::asset('dashboard/assets/img/faces/1.jpg')}}" alt="profile" class="img-xs rounded-circle">
									<img src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}" alt="profile" class="img-xs rounded-circle">
									<img src="{{URL::asset('dashboard/assets/img/faces/13.jpg')}}" alt="profile" class="img-xs rounded-circle">
									<img src="{{URL::asset('dashboard/assets/img/faces/14.jpg')}}" alt="profile" class="img-xs rounded-circle">
									<img src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}" alt="profile" class="img-xs rounded-circle">
									<img src="{{URL::asset('dashboard/assets/img/faces/16.jpg')}}" alt="profile" class="img-xs rounded-circle">
								</div>
							</div><!-- card-body -->
						</div>
					</div>
						...
						<div class="card order-list">
							<div class="card-body">
								...
								<ul class="list list-noborders pb-0 mb-0">
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{URL::asset('dashboard/assets/img/faces/3.jpg')}}" alt="Profile Image">
										<div class=" mr-3">
											<h6 class="mb-1 font-weight-medium">Lottie Arnold</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10250</p>
										</div>
										<div class="mr-auto d-flex">
											<img class="img-sm ml-1" src="{{URL::asset('dashboard/assets/img/ecommerce/03.jpg')}}" alt="thumb images">
											<img class="img-sm" src="{{URL::asset('dashboard/assets/img/ecommerce/08.jpg')}}" alt="thumb images">
										</div>
									</li>
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}" alt="Profile Image">
										<div class=" mr-3">
											<h6 class="mb-1 font-weight-medium">Alan Macedo</h6>
											<p class="mb-0 tx-13 text-muted">#PRD-10251</p>
										</div>
										<div class="mr-auto d-flex">
											<img class="img-sm ml-1" src="{{URL::asset('dashboard/assets/img/ecommerce/04.jpg')}}" alt="thumb images">
											<img class="img-sm" src="{{URL::asset('dashboard/assets/img/ecommerce/05.jpg')}}" alt="thumb images">
										</div>
									</li>
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}" alt="Profile Image">
										<div class=" mr-3">
											<h6 class="mb-1 font-weight-medium">Bruce Tran</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10252</p>
										</div>
										<div class="mr-auto d-flex">
											<img class="img-sm ml-1" src="{{URL::asset('dashboard/assets/img/ecommerce/06.jpg')}}" alt="thumb images">
											<img class="img-sm" src="{{URL::asset('dashboard/assets/img/ecommerce/07.jpg')}}" alt="thumb images">
										</div>
									</li>
									<li class="list-item">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}" alt="Profile Image">
										<div class=" mr-3">
											<h6 class="mb-1 font-weight-medium">Mina Harper</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10253</p>
										</div>
										<div class="mr-auto d-flex">
											<img class="img-sm ml-1" src="{{URL::asset('dashboard/assets/img/ecommerce/08.jpg')}}" alt="thumb images">
											<img class="img-sm" src="{{URL::asset('dashboard/assets/img/ecommerce/09.jpg')}}" alt="thumb images">
										</div>
									</li>
									<li class="list-item pb-0 mb-0">
										<img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{URL::asset('dashboard/assets/img/faces/8.jpg')}}" alt="Profile Image">
										<div class=" mr-3">
											<h6 class="mb-1 font-weight-medium">Maria Quinn</h6>
											<p class="mb-0 text-muted tx-13">#PRD-10254</p>
										</div>
										<div class="mr-auto d-flex">
											<img class="img-sm ml-1" src="{{URL::asset('dashboard/assets/img/ecommerce/02.jpg')}}" alt="thumb images">
											<img class="img-sm" src="{{URL::asset('dashboard/assets/img/ecommerce/01.jpg')}}" alt="thumb images">
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="rating-scroll ps ps--active-y">
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/5.jpg')}}">
											</a>
										</div>
								...
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/9.jpg')}}">
											</a>
										</div>
										<div class="media-body">
											<div class="d-flex">
								...
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/4.jpg')}}">
											</a>
										</div>
										<div class="media-body">
											<div class="d-flex">
								...
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/7.jpg')}}">
											</a>
										</div>
										<div class="media-body">
											<div class="d-flex">
								...
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/12.jpg')}}">
											</a>
										</div>
										<div class="media-body">
											<div class="d-flex">
								...
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/13.jpg')}}">
											</a>
										</div>
										<div class="media-body">
											<div class="d-flex">
								...
								<div class="pl-3 pr-3 py-3 border-bottom">
									<div class="media mt-0">
										<div class="d-flex ml-3">
											<a href="#">
												<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{URL::asset('dashboard/assets/img/faces/2.jpg')}}">
											</a>
										</div>
										<div class="media-body">
											<div class="d-flex">
							...
							<div class="card-body p-0">
								<div class="browser-stats">
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{URL::asset('dashboard/assets/img/svgicons/chrome.svg')}}" alt="img" class="ht-30 wd-30 ml-2">
											<div class="">
												<h6 class="">Chrome</h6>
									...
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{URL::asset('dashboard/assets/img/svgicons/opera.svg')}}" alt="img" class="ht-30 wd-30 ml-2">
											<div class="">
												<h6 class="">Opera</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
											</div>
									...
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{URL::asset('dashboard/assets/img/svgicons/edge.svg')}}" alt="img" class="ht-30 wd-30 ml-2">
											<div class="">
												<h6 class="">Edge</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
											</div>
									...
									<div class="d-flex align-items-center item  border-bottom">
										<div class="d-flex">
											<img src="{{URL::asset('dashboard/assets/img/svgicons/firefox.svg')}}" alt="img" class="ht-30 wd-30 ml-2">
											<div class="">
												<h6 class="">Firefox</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
											</div>
									...
									<div class="d-flex align-items-center item border-bottom">
										<div class="d-flex">
											<img src="{{URL::asset('dashboard/assets/img/svgicons/uc-browser.svg')}}" alt="img" class="ht-30 wd-30 ml-2">
											<div class="">
									...
									<div class="d-flex align-items-center item">
										<div class="d-flex">
											<img src="{{URL::asset('dashboard/assets/img/svgicons/safari.svg')}}" alt="img" class="ht-30 wd-30 ml-2">
											<div class="">
												<h6 class="">Safari</h6>
												<span class="sub-text">Mozilla Foundation, Inc.</span>
											</div>
