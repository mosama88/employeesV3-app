										...
										<div class="card card-body pd-20 pd-md-40 border shadow-none">
											...
											<div class="form-group">
												...
												<div class="pos-relative">
													...
													<div class="d-flex pos-absolute t-5 r-10"><img alt="" class="wd-30 mg-r-5" src="{{URL::asset('dashboard/assets/img/visa.png')}}"> <img alt="" class="wd-30" src="{{URL::asset('dashboard/assets/img/mastercard.png')}}"></div>
												</div>
											</div>
											<div class="form-group">
...
<!-- Form-layouts js -->
<script src="{{URL::asset('dashboard/assets/js/form-layouts.js')}}"></script>
@endsection
