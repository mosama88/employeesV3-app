...
<link href="{{URL::asset('dashboard/assets/plugins/fullcalendar/fullcalendar.min.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
							...
							<div class=" card card--calendar p-0 mg-b-20">
								<div class="p-4 border-bottom">
									...
									<div class="text-center mx-auto">
										<img src="{{URL::asset('dashboard/assets/img/media/calendar.png')}}" alt="calendar" class="ht-80p wd-80p">
									</div>
								</div>
...
@section('js')
<!-- moomet min js -->
<script src="{{URL::asset('dashboard/assets/plugins/moment/min/moment.min.js')}}"></script>
<!--Internal  Date picker js -->
<script src="{{URL::asset('dashboard/assets/plugins/jquery-ui/ui/widgets/datepicker.js')}}"></script>
<!--Internal  Fullcalendar js -->
<script src="{{URL::asset('dashboard/assets/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
<!-- Internal Select2.full.min js -->
<script src="{{URL::asset('dashboard/assets/plugins/select2/js/select2.full.min.js')}}"></script>
<!--Internal App calendar js -->
<script src="{{URL::asset('dashboard/assets/js/app-calendar-events.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/js/app-calendar.js')}}"></script>
@endsection
