				...
				<div class="col-md-5 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="{{URL::asset('dashboard/assets/img/media/underconstruction.png')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div>
				<!-- The content half -->
...
@section('js')
<!--- Jquery.Coutdown js -->
<script src="{{URL::asset('dashboard/assets/plugins/jquery-countdown/jquery.lwtCountdown-1.0.js')}}"></script>
<script src="{{URL::asset('dashboard/assets/plugins/jquery-countdown/count-down.js')}}"></script>
@endsection
